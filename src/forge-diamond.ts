...
export function handleAddedToQueue(event: AddedToQueue): void {
  ...
  //
  // - contract.forgeTime(...)
  // - contract.geodeTokenIdFromRsm(...)
  // - contract.getAavegotchiSmithingLevel(...)
  // - contract.getAavegotchiSmithingSkillPts(...)
  // - contract.getCoreTokenId(...)
  // - contract.getSmithingLevelMultiplierBips(...)
  // - contract.isForgeable(...)
  // - contract.isGotchiForging(...)
}
